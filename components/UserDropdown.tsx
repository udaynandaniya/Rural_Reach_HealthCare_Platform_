...
import { AnimatePresence } from "framer-motion"
import { useState, useRef, useEffect } from "react"
import { User, Settings, LogOut, ChevronDown, Users, UserCheck, Building2, Shield, Trash2 } from "lucide-react"
import { Button } from "@/components/ui/button"
import { useRouter } from "next/navigation"
import Swal from "sweetalert2"
import { useAuth } from "@/app/contexts/AuthProvider"
...
const handleDeleteAccount = async () => {
  ...
  // Show loading alert while waiting for short deletion
  Swal.fire({
    title: "Deleting...",
    text: "Please wait...",
  ...
  try {
    ...
    if (res.ok) {
      ...
      await fetch("/api/auth/logout", { method: "POST" }) // Your logout API
