...
//           transition={{ duration: 0.6, delay: 0.3 }}
//         >
//           <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6 sm:space-y-6">
//            <TabsList className={`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2 w-full text-xs sm:text-sm`}>
//       {isHandleEmergency && <TabsTrigger value="emergencies">Emergency Alerts</TabsTrigger>}
//               <TabsTrigger value="create">Create Post</TabsTrigger>
//               <TabsTrigger value="own-posts">Own Posts</TabsTrigger>
//               <TabsTrigger value="all-posts">All Posts</TabsTrigger>
...
//             {/* Create Post Tab */}
//           <TabsContent value="create" className="space-y-6 px-2 sm:px-4 md:px-6">
//      <Card>
//                 <CardHeader>
//                   <CardTitle className="flex items-center space-x-2">
//                     <Plus className="w-5 h-5" />
...
const ThemeToggle = () => <div>Theme Toggle</div>
const UserDropdown = () => <div>User Dropdown</div>
const AnimatedHealthIcons = () => <div>Animated Health Icons</div>
...
const Swal = {
  fire: (options: any) => Promise.resolve({ isConfirmed: true }),
}

const useAuth = () => ({
  user: { name: "Hospital Name", email: "hospital@example.com" },
})
...
export default function HospitalDashboard() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center">
        <div className="text-center">
          <motion.div
            ...
            transition={{ duration: 1, repeat: Number.POSITIVE_INFINITY, ease: "linear" }}
          />
          <p className="text-gray-600 dark:text-gray-400 text-base sm:text-lg">Loading hospital dashboard...</p>
        </div>
      </div>
    )
  }

  const quickStatsGridCols = isHandleEmergency
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-40 relative">
        ...
        <div className="container mx-auto px-3 sm:px-4 lg:px-6 py-3 sm:py-4 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
              <Link href="/" passHref>
                <Button
                  variant="ghost"
                  size="icon"
                  className="text-gray-600 dark:text-gray-400 p-1.5 sm:p-2 lg:p-3 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12"
                >
              ...
              <motion.div
                className="w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 bg-gradient-to-br from-purple-500 to-blue-500 rounded-xl flex items-center justify-center shadow-lg"
                animate={{
                  scale: [1, 1.1, 1],
                  rotate: [0, 5, -5, 0],
                }}
            ...
            {/* Right section - Controls */}
            <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-4 w-full sm:w-auto justify-between sm:justify-end">
              {/* Manual Refresh Button - Always visible */}
              <Button
                variant="outline"
                size="sm"
              ...
              {isHandleEmergency && (
                <>
                  <div className="hidden xl:flex items-center space-x-2 text-xs text-gray-600 dark:text-gray-400">
                    <Clock className="w-3 h-3" />
                    <span>Last: {lastChecked.toLocaleTimeString()}</span>
                  </div>
                  <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              {/* Notification Bell */}
              <motion.div className="relative" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <Bell className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-gray-600 dark:text-gray-400" />
                {notifications > 0 && isHandleEmergency && (
                  <motion.span
                    className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 bg-red-500 text-white text-xs rounded-full w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 flex items-center justify-center"
                    animate={{ scale: [1, 1.2, 1] }}
                    transition={{ duration: 1, repeat: Number.POSITIVE_INFINITY }}
                  >
                    {notifications}
      ...
      {notifications > 0 && isHandleEmergency && (
        <motion.div
          className="bg-red-500 text-white py-2 px-3 sm:px-4 lg:px-6 flex flex-col sm:flex-row items-start sm:items-center justify-between sticky top-[60px] sm:top-[70px] z-30 shadow-md gap-2 sm:gap-0"
          initial={{ opacity: 0, y: -50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        >
          ...
          <Button
            onClick={() => setActiveTab("emergencies")}
            className="bg-white text-red-600 hover:bg-gray-100 px-3 sm:px-4 py-1 rounded-md text-xs sm:text-sm font-medium w-full sm:w-auto"
          >
            View Alerts
          </Button>
        </motion.div>
      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        ...
        >
          ...
          {/* Link to All Hospitals Page */}
          <Link href="/all-hospitals" passHref>
            <Button variant="outline" className="mt-3 sm:mt-4 bg-transparent text-xs sm:text-sm">
              <Building2 className="w-3 h-3 sm:w-4 sm:h-4 mr-2" /> View All Hospitals
            </Button>
          </Link>
        </motion.div>
        ...
        {/* Quick Stats */}
        <motion.div
          className={`grid ${quickStatsGridCols} gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6 lg:mb-8`}
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
        >
              ...
              <Card className="hover:shadow-lg transition-all duration-300">
                <CardContent className="p-3 sm:p-4 lg:p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Emergency Alerts</p>
                      <p className="text-lg sm:text-xl lg:text-2xl font-bold text-red-600">{emergencyAlerts.length}</p>
                      <p className="text-xs text-gray-500">{notifications} pending</p>
                    </div>
                    <motion.div
                      className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-red-100 dark:bg-red-900 rounded-full flex items-center justify-center"
                      animate={{
                        scale: notifications > 0 ? [1, 1.2, 1] : 1,
                      }}
                      transition={{ duration: 2, repeat: notifications > 0 ? Number.POSITIVE_INFINITY : 0 }}
            ...
            <Card className="hover:shadow-lg transition-all duration-300">
              <CardContent className="p-3 sm:p-4 lg:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">My Posts</p>
                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-purple-600">{ownPosts.length}</p>
                    <p className="text-xs text-gray-500">Published content</p>
                  </div>
                  <motion.div
                    className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center"
                    animate={{ rotate: [0, 360] }}
                    transition={{ duration: 10, repeat: Number.POSITIVE_INFINITY, ease: "linear" }}
                  >
                    <MessageSquare className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-purple-600" />
                  </motion.div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-all duration-300">
              <CardContent className="p-3 sm:p-4 lg:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">All Posts</p>
                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-blue-600">{allOtherPosts.length}</p>
                    <p className="text-xs text-gray-500">Community content</p>
                  </div>
                  <motion.div
                    className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center"
                    animate={{ rotate: [0, 360] }}
                    transition={{ duration: 10, repeat: Number.POSITIVE_INFINITY, ease: "linear" }}
                  >
            ...
            <Card className="hover:shadow-lg transition-all duration-300">
              <CardContent className="p-3 sm:p-4 lg:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">My Announcements</p>
                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-blue-600">{ownAnnouncements.length}</p>
                    <p className="text-xs text-gray-500 mt-1">Shared updates</p>
                  </div>
                  <motion.div
                    className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center"
                    ...
                    transition={{ duration: 3, repeat: Number.POSITIVE_INFINITY }}
                  >
                    <Megaphone className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-600" />
                  </motion.div>
                </div>
              </CardContent>
            </Card>
                ...
                <CardContent className="p-3 sm:p-4 lg:p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Status</p>
                      <p
                        className={`text-lg sm:text-xl lg:text-2xl font-bold ${isAvailable ? "text-green-600" : "text-red-600"}`}
                      >
                        {isAvailable ? "Available" : "Unavailable"}
                      </p>
                      <p className="text-xs text-gray-500">Emergency services</p>
                    ...
                    >
                      <Activity
                        className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 ${isAvailable ? "text-green-600" : "text-red-600"}`}
                      />
                    </motion.div>
                  </div>
                </CardContent>
        ...
        >
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
            <TabsList
              className={`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-1 sm:gap-2 w-full text-xs sm:text-sm p-1 sm:p-1.5`}
            >
              {isHandleEmergency && (
                <TabsTrigger value="emergencies" className="px-2 sm:px-3 py-1.5 sm:py-2">
                  <span className="hidden sm:inline">Emergency Alerts</span>
                  <span className="sm:hidden">Alerts</span>
                </TabsTrigger>
              )}
              <TabsTrigger value="create" className="px-2 sm:px-3 py-1.5 sm:py-2">
                <span className="hidden sm:inline">Create Post</span>
                <span className="sm:hidden">Create</span>
              </TabsTrigger>
              <TabsTrigger value="own-posts" className="px-2 sm:px-3 py-1.5 sm:py-2">
                <span className="hidden sm:inline">Own Posts</span>
                <span className="sm:hidden">My Posts</span>
              </TabsTrigger>
              <TabsTrigger value="all-posts" className="px-2 sm:px-3 py-1.5 sm:py-2">
                <span className="hidden sm:inline">All Posts</span>
                <span className="sm:hidden">All</span>
              </TabsTrigger>
              <TabsTrigger value="announcements" className="px-2 sm:px-3 py-1.5 sm:py-2">
                  ...
                  <CardHeader className="p-3 sm:p-4 lg:p-6">
                    <CardTitle className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
                      <div className="flex items-center space-x-2 flex-wrap">
                        ...
                        <span className="text-sm sm:text-base lg:text-lg">Emergency Alerts</span>
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() => setAutoRefresh(!autoRefresh)}
                        className={`${autoRefresh ? "bg-green-50 border-green-200" : ""} text-xs sm:text-sm px-2 sm:px-3 w-full sm:w-auto`}
                      >
                        Auto-refresh {autoRefresh ? "ON" : "OFF"}
                      </Button>
                    </CardTitle>
                  ...
                  <CardContent className="p-3 sm:p-4 lg:p-6">
                    {emergencyAlerts.length > 0 ? (
                                  ...
                                  <div>
                                    ...
                                    <div className="space-y-1 text-xs sm:text-sm">
                                      <div className="flex items-center space-x-2">
                                        ...
                                        <span className="truncate">{alert.userInfo.name}</span>
                                      </div>
                                      <div className="flex items-center space-x-2">
                                        <Phone className="w-3 h-3 sm:w-4 sm:h-4 text-gray-500 flex-shrink-0" />
                                        <span className="truncate">{alert.userInfo.phone}</span>
                                      </div>
                                      <div className="flex items-center space-x-2">
                                        <Mail className="w-3 h-3 sm:w-4 sm:h-4 text-gray-500 flex-shrink-0" />
                                        <span className="break-all text-xs">{alert.userInfo.email}</span>
                                      </div>
                                    </div>
                                  </div>
                                  <div>
                                    ...
                                    <div className="space-y-1 text-xs sm:text-sm">
                                      {alert.distance && (
                                        <div className="flex items-center space-x-2">
                                          <Navigation className="w-3 h-3 sm:w-4 sm:h-4 text-green-500 flex-shrink-0" />
                                          <span className="font-semibold text-green-600">{alert.distance}km away</span>
                                          {alert.proximityMethod && (
                                            <span className="text-xs text-gray-500">({alert.proximityMethod})</span>
                                          )}
                                      ...
                                      <div className="bg-blue-50 dark:bg-blue-900/20 p-2 sm:p-3 rounded-lg border border-blue-200 dark:border-blue-800">
                                        <div className="flex items-start space-x-2">
                                          ...
                                          <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-blue-700 dark:text-blue-300 text-xs sm:text-sm mb-2 break-words">
                                              📍{" "}
                                              {alert.location?.lat && alert.location?.lng
                                                ? `GPS: ${alert.location.lat.toFixed(4)}, ${alert.location.lng.toFixed(4)}`
                                                : formatLocationAddress(alert.location?.address) ||
                                            ...
                                            <motion.button
                                              ...
                                              className="w-full bg-blue-600 hover:bg-blue-700 text-white px-2 sm:px-3 py-1.5 sm:py-2 rounded-md text-xs sm:text-sm font-medium flex items-center justify-center space-x-1 sm:space-x-2 transition-colors"
                                            >
                                  ...
                                  <div className="flex flex-wrap gap-1.5 sm:gap-2 w-full sm:w-auto">
                                    {alert.hospitalAlertStatus === "pending" && (
                                      <Button
                                        ...
                                        className="animate-pulse text-xs px-2 py-1 sm:px-3 sm:py-1.5 flex-1 sm:flex-none"
                                      >
                                        🚨 RESPOND NOW
                                      </Button>
                                    )}
                                    {alert.status === "accepted" && (
                                      <>
                                        <Button
                                          ...
                                          className="text-blue-600 hover:text-blue-800 hover:bg-blue-50 text-xs px-2 py-1 sm:px-3 sm:py-1.5"
                                        >
                                        ...
                                        <Button
                                          ...
                                          className="text-red-600 hover:text-red-800 hover:bg-red-50 text-xs px-2 py-1 sm:px-3 sm:py-1.5"
                                        >
                      ...
                      <div className="text-center py-8 sm:py-12">
                        <AlertTriangle className="w-12 h-12 sm:w-16 sm:h-16 text-gray-400 mx-auto mb-3 sm:mb-4" />
                        <h3 className="text-base sm:text-lg font-semibold text-gray-600 dark:text-gray-400 mb-2">
                          No Emergency Alerts
                        </h3>
                        <p className="text-sm sm:text-base text-gray-500">
                          No emergency alerts in your area at the moment
                        </p>
                        <p className="text-xs sm:text-sm text-gray-400 mt-2">
                          System checks every 30 seconds for new alerts
                        </p>
                      </div>
                    )}
                  </CardContent>
            ...
            <TabsContent value="create" className="space-y-4 sm:space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4 sm:space-y-6 p-3 sm:p-4 lg:p-6">
                  <div>
                    <label className="block text-xs sm:text-sm font-medium mb-2">Post Title *</label>
                    <Input
                      value={newPost.title}
                      onChange={(e) => setNewPost({ ...newPost, title: e.target.value })}
                      placeholder="e.g., New Emergency Department Now Open 24/7"
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      {ownPosts.map((post, index) => (
                        ...
                        >
                          <div className="flex flex-col sm:flex-row items-start justify-between mb-3 gap-3">
                            ...
                            <div className="flex items-center space-x-2 flex-shrink-0">
                              <Dialog>
                                ...
                                <DialogContent className="max-w-xs sm:max-w-2xl mx-4 sm:mx-auto max-h-[90vh] overflow-y-auto">
                                  <DialogHeader>
                                  ...
                                  <div className="space-y-4">
                                    ...
                                    <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                                      <Button
                                        ...
                                        className="bg-purple-600 hover:bg-purple-700 text-sm flex-1"
                                      >
                                        Save Changes
                                      </Button>
                                      <Button
                          ...
                          <p className="text-gray-700 dark:text-gray-300 mb-4 line-clamp-3 text-sm sm:text-base break-words">
                            {post.content}
                          </p>
              ...
              <Card>
                ...
                <CardContent className="p-3 sm:p-4 lg:p-6">
                  {allOtherPosts.length > 0 ? (
                    ...
                    <div className="text-center py-8 sm:py-12">
                      <Stethoscope className="w-12 h-12 sm:w-16 sm:h-16 text-gray-400 mx-auto mb-3 sm:mb-4" />
                      <h3 className="text-base sm:text-lg font-semibold text-gray-600 dark:text-gray-400 mb-2">
                        No posts yet
                      </h3>
                      <p className="text-sm sm:text-base text-gray-500">
                ...
                <CardContent className="space-y-4 sm:space-y-6 p-3 sm:p-4 lg:p-6">
                  <div className="space-y-4 border-b pb-4 mb-4">
                    ...
                    <Dialog open={isAnnouncementFormOpen} onOpenChange={setIsAnnouncementFormOpen}>
                      ...
                      <DialogContent className="max-w-xs sm:max-w-[425px] mx-4 sm:mx-auto">
                        <DialogHeader>
                          <DialogTitle className="text-base sm:text-lg">{"Create New Announcement"}</DialogTitle>
                        </DialogHeader>
                        <div className="space-y-4">
                          <div>
                  ...
                  {ownAnnouncements.length > 0 ? (
                    ...
                    <div className="text-center py-8 sm:py-12">
                      <Megaphone className="w-12 h-12 sm:w-16 sm:h-16 text-gray-400 mx-auto mb-3 sm:mb-4" />
                      <h3 className="text-base sm:text-lg font-semibold text-gray-600 dark:text-gray-400 mb-2">
                        No announcements yet
                      </h3>
                      <p className="text-sm sm:text-base text-gray-500 mb-4">
      ...
      <Dialog open={showAlertDialog} onOpenChange={setShowAlertDialog}>
        <DialogContent className="max-w-xs sm:max-w-2xl mx-4 sm:mx-auto max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-base sm:text-lg lg:text-xl">🚨 Emergency Alert Response</DialogTitle>
          </DialogHeader>
          {selectedAlert && (
            <div className="space-y-4 sm:space-y-6">
              <Alert className="border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-900/20">
                ...
                <AlertDescription className="text-sm sm:text-base">
                  <strong>URGENT:</strong> Patient {selectedAlert.userInfo.name} needs immediate medical assistance.
                </AlertDescription>
              </Alert>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-3 sm:space-y-4">
                  <h3 className="font-semibold text-base sm:text-lg">Patient Details</h3>
                  <div className="space-y-2 text-sm sm:text-base">
                    <div className="flex items-center space-x-2">
                      <User className="w-4 h-4 text-gray-500" />
                      <span>{selectedAlert.userInfo.name}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Phone className="w-4 h-4 text-gray-500" />
                      <span>{selectedAlert.userInfo.phone}</span>
                    ...
                    <div className="flex items-center space-x-2">
                      <Mail className="w-4 h-4 text-gray-500" />
                      <span className="break-all text-sm">{selectedAlert.userInfo.email}</span>
                    </div>
                  </div>
                </div>

                <div className="space-y-3 sm:space-y-4">
                  <h3 className="font-semibold text-base sm:text-lg">Location & Time</h3>
                  <div className="space-y-2 text-sm sm:text-base">
                    {selectedAlert.distance && (
                      <div className="flex items-center space-x-2">
                        <Navigation className="w-4 h-4 text-green-500" />
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="break-words text-sm">
                        {selectedAlert.location?.lat && selectedAlert.location?.lng
                          ? `GPS: ${selectedAlert.location.lat.toFixed(4)}, ${selectedAlert.location.lng.toFixed(4)}`
                          : formatLocationAddress(selectedAlert.location?.address) || "Location not available"}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              {selectedAlert.message && (
                <div>
                  <h3 className="font-semibold mb-2 text-base sm:text-lg">Emergency Message</h3>
                  <p className="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 p-3 sm:p-4 rounded-lg text-sm sm:text-base break-words">
                    {selectedAlert.message}
                  </p>
                </div>
              )}
              ...
              <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 pt-4 border-t">
                <Button
                  onClick={() => handleResponse("accept")}
                  disabled={responding}
                  className="bg-green-600 hover:bg-green-700 text-white flex-1 text-sm sm:text-base py-2 sm:py-3"
                >
                  {responding ? (
                    <>
                      <motion.div
