...
export default function LandingPage() {
  ...
  <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden">
    ...
    {/* Header */}
    <header className="relative z-50 flex flex-col sm:flex-row items-center justify-between p-4 sm:p-6 lg:px-12 gap-4 sm:gap-0">
      {/* Logo and Brand */}
      <motion.div
        className="flex items-center space-x-3"
        initial={{ opacity: 0, x: -50 }}
      ...
      {/* Navigation */}
      <motion.div
        className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-8 text-center"
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, delay: 0.2 }}
      >
        <Link href="#" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-colors">Home</Link>
        <Link href="#services" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-colors">Services</Link>
        ...
        <Link href="#contact" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-colors">Contact</Link>
      </motion.div>
    ...
    <main className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-120px)] px-4 sm:px-6 text-center">
      ...
      >
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8">
          <span className="text-gray-900 dark:text-white">A Platform where </span>
          <span className="relative inline-block">
            <span className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-4 py-2 rounded-lg transform -rotate-1 inline-block">Healthcare</span>
          </span>
          <span className="text-gray-900 dark:text-white"> and </span>
          <span className="relative inline-block">
            <span className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-lg transform rotate-1 inline-block">Emergency</span>
          </span>
          <br />
          <span className="text-gray-900 dark:text-white">Meet Together</span>
        </h1>
        ...
        {/* Subtitle */}
        <motion.p
          className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-4 max-w-3xl mx-auto leading-relaxed"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.8, delay: 1 }}
        >
          Connect with trusted healthcare providers, track your wellness journey, and access emergency care when you need it most.
        </motion.p>

        <motion.p
          className="text-sm sm:text-base text-gray-500 dark:text-gray-400 mb-12 max-w-2xl mx-auto"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.8, delay: 1.2 }}
        >
          RuralReach bridges the gap between rural communities and quality healthcare — built for those who deserve better access to medical care.
        </motion.p>
      ...
      {/* Role selection, services, contact sections */}
      {/* Already written well; only grid/layout tweaks needed — you already have these sections implemented correctly and responsively with minor edits above. */}
    </main>
