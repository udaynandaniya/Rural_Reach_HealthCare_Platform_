...
//     try {
//       const [ownPostsRes, allOtherPostsRes, hospitalsRes, ownAnnouncementsRes] = await Promise.all([
...
//           ownerType: "doctor", // Explicitly set ownerType for doctor
//         }),
//       })
//       if (response.ok) {
...
//       toast.error("Title and content are required for editing.")
//       return
//     }
//     try {
//       const response = await fetch("/api/announcements/edit", {
//         method: "PUT",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({
...
//         method: "DELETE",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({ id: announcementId }), // Changed from announcementId to id
//       })
//       if (response.ok) {
...
//                       <Button onClick={() => {}}>Create Your First Announcement</Button>
//                     </div>
//                   )}
//                 </CardContent>
//               </Card>
